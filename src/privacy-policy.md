...
Inoltre, a Farmacia potrebbe affidare alcune operazioni di trattamento dei dati personali effettuate per le Finalità di cui al Paragrafo 3 che precede a categorie di soggetti destinatari, appositamente nominati dala Farmacia medesimo, se necessario, quali responsabili del trattamento, tra cui, a titolo esemplificativo e non esaustivo:

i fornitori di servizi tecnici del Sito;
gli hosting provider che offrono servizi per l’hosting del Sito.
L’elenco completo ed aggiornato dei responsabili e degli incaricati al trattamento è custodito presso la sede dela Farmacia e potrà essere richiesto con le modalità di cui al successivo Paragrafo.
...
La gestione e la conservazione dei dati avverranno su server dela Farmacia ubicati all’interno dell’Unione Europea e/o di società terze incaricate e debitamente nominate quali responsabili del trattamento.
...
I dati personali per le Finalità di cui al Paragrafo 3, lettere a), b), e c) saranno conservati e trattati per tutta la durata della navigazione e, successivamente alla sua cessazione, per qualunque ragione intervenuta, per un periodo non superiore a 24 mesi.

I dati personali raccolti per le Finalità di cui Paragrafo 3, lettera d) saranno conservati solo per il tempo strettamente necessario a conseguire le Finalità per cui sono stati raccolti e, in ogni caso, non oltre 10 anni dalla loro raccolta.

I dati personali raccolti per la Finalità di cui Paragrafo 3, lettera e) saranno conservati solo per il tempo strettamente necessario a conseguire la Finalità e comunque non oltre 24 mesi dalla loro raccolta.

Al termine dei periodi di conservazione i dati personali saranno cancellati, salvo che non ci siano ulteriori interessi legittimi dela Farmacia e/o obblighi di legge che rendano necessaria, previa minimizzazione, la loro conservazione.
...
il “diritto di accesso” e nello specifico ottenere la conferma dell’esistenza o meno di dati personali che lo riguardano e la loro comunicazione in forma intelligibile;
...
il “diritto di limitazione di trattamento” ossia il diritto di ottenere dal Titolare la limitazione del trattamento in alcuni casi previsti ai sensi della Normativa Privacy;
